...
pyrogram.utils.MIN_CHANNEL_ID = -1002389011755

# Setting SUPPORT_CHAT directly here
SUPPORT_CHAT = int(os.environ.get("SUPPORT_CHAT", "-1002353672428"))
            ...
            try:
                ...
                await self.send_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/mr_boomsir")
                        ]]
                    )
                )
