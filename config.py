...
class Config(object):
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME","Jokermogo")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://Jokermogodbs:24568753@Adil@cluster0.uifh8.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    PORT = os.environ.get("PORT", "25")
 
    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://graph.org/file/29a3acbbab9de5f45a5fe.jpg")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '7568018833').split()]
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'force_test').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002363962991"))
